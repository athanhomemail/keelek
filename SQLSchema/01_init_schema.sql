...
CREATE TABLE IF NOT EXISTS room_settings (
    ...
    comm_3top DECIMAL(5,2) NOT NULL DEFAULT 8.00 COMMENT '% ส่วนแบ่ง 3 ตัวบน',
    comm_3tod DECIMAL(5,2) NOT NULL DEFAULT 8.00 COMMENT '% ส่วนแบ่ง 3 ตัวโต๊ด',
    comm_2top DECIMAL(5,2) NOT NULL DEFAULT 5.00 COMMENT '% ส่วนแบ่ง 2 ตัวบน',
    comm_2bottom DECIMAL(5,2) NOT NULL DEFAULT 5.00 COMMENT '% ส่วนแบ่ง 2 ตัวล่าง',
    comm_run_top DECIMAL(5,2) NOT NULL DEFAULT 5.00 COMMENT '% ส่วนแบ่ง วิ่งบน',
    comm_run_bottom DECIMAL(5,2) NOT NULL DEFAULT 5.00 COMMENT '% ส่วนแบ่ง วิ่งล่าง',
    commission_rate DECIMAL(5,2) NOT NULL DEFAULT 10.00 COMMENT '% ส่วนแบ่งลูกทีมทั่วไป (สำรอง)',
